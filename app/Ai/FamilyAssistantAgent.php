...
class FamilyAssistantAgent
{
    ...
    public function stream(string $prompt, array $history = []): StreamableAgentResponse
    {
        ...
        - Listing the user's personal schedule / roster shifts (use the list_roster tool)
        ...
        When the user asks about their work schedule, roster, or shifts, use the list_roster tool.
