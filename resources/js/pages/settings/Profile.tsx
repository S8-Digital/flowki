...
import { CalendarCheck, CalendarX, CheckCircle2, Link2, Link2Off, RefreshCw, Shield, ShieldCheck, ShieldOff } from 'lucide-react';
...
export default function Profile({ mustVerifyEmail, status, hasGoogleCalendarConnected, twoFactorEnabled, twoFactorConfirmed }: Props) {
    const page = usePage<{
        auth: {
