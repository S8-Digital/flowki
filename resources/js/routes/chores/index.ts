 ...
 */
export const update = (
    args: { chore: number | { id: number } } | [chore: number | { id: number }] | number | { id: number },
...
update.url = (args: { chore: number | { id: number } } | [chore: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        chore: typeof args.chore === 'object' ? args.chore.id : args.chore,
    };

    return update.definition.url.replace('{chore}', parsedArgs.chore.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{chore}', parsedArgs.chore.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
complete.url = (
    ...
    return complete.definition.url.replace('{chore}', parsedArgs.chore.toString()).replace(/\/+$/, '') + queryParams(options);
};
