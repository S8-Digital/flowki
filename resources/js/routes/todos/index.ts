 ...
 */
export const update = (
    args: { todo: number | { id: number } } | [todo: number | { id: number }] | number | { id: number },
...
update.url = (args: { todo: number | { id: number } } | [todo: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    const parsedArgs = {
        todo: typeof args.todo === 'object' ? args.todo.id : args.todo,
    };

    return update.definition.url.replace('{todo}', parsedArgs.todo.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (args: { todo: number | { id: number } } | [todo: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return destroy.definition.url.replace('{todo}', parsedArgs.todo.toString()).replace(/\/+$/, '') + queryParams(options);
};
