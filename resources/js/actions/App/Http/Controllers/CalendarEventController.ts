 ...
 */
export const update = (
    args: { calendarEvent: number | { id: number } } | [calendarEvent: number | { id: number }] | number | { id: number },
...
update.url = (
    ...
    const parsedArgs = {
        calendarEvent: typeof args.calendarEvent === 'object' ? args.calendarEvent.id : args.calendarEvent,
    };

    return update.definition.url.replace('{calendarEvent}', parsedArgs.calendarEvent.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
move.url = (
    ...
    return move.definition.url.replace('{calendarEvent}', parsedArgs.calendarEvent.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{calendarEvent}', parsedArgs.calendarEvent.toString()).replace(/\/+$/, '') + queryParams(options);
};
