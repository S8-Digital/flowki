 ...
 */
export const update = (
    args: { dashboardWidget: number | { id: number } } | [dashboardWidget: number | { id: number }] | number | { id: number },
...
update.url = (
    ...
    const parsedArgs = {
        dashboardWidget: typeof args.dashboardWidget === 'object' ? args.dashboardWidget.id : args.dashboardWidget,
    };

    return update.definition.url.replace('{dashboardWidget}', parsedArgs.dashboardWidget.toString()).replace(/\/+$/, '') + queryParams(options);
};
...
destroy.url = (
    ...
    return destroy.definition.url.replace('{dashboardWidget}', parsedArgs.dashboardWidget.toString()).replace(/\/+$/, '') + queryParams(options);
};
